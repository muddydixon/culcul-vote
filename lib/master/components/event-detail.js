  ...
  render (){
    ...
    return <div className="container">
      <h1 className="page-header affix-top">
        ...
        <button className="btn btn-info" onClick={this.ping.bind(this)} style={{backgroundImage: "linear-gradient(to bottom, #f0ad4e 0, #eb9316 100%)", borderColor: "#e38d13"}}>存在確認</button>
        <input className="form-control" style={{display: "inline-block"}} type="text" value={num_exists}/>
      </h1>
      <div className="row vote-container" style={{display: "inline-block"}}>
